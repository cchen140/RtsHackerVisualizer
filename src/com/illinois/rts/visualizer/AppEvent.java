...
public class AppEvent extends Event {
    ...
    public void drawEvent(Graphics2D g, int offsetX, int offsetY, double scaleX, double scaleY)
    {
        ...
        if (task.isBoxChecked()) {
            ...
            {
                g.drawString(note, scaledOffsetX-5, offsetY + ScheduleEvent.DRAW_HEIGHT + 80);
                drawArrow(g, scaledOffsetX, offsetY + ScheduleEvent.DRAW_HEIGHT + 50, scaledOffsetX, offsetY + ScheduleEvent.DRAW_HEIGHT);
            }
            else {
