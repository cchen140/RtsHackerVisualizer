...
public class ArrivalSegment extends Interval {
    ...
    public ArrivalSegment(int inBegin, int inEnd, int inSegmentType) {
        super(inBegin, inEnd);
...
//    }
    ...
    public ArrayList<Interval> getIntersectionWithPeriodShift(Interval fixedInterval, int inPeriod) {
        ArrayList<Interval> resultIntersections = new ArrayList<>();

        int periodShiftValue = (fixedInterval.getBegin()-this.getBegin()) / inPeriod;
